...
Version 3.2 (30 December 2025) &ndash; cf. [version 3.0](/handbook/v3/ch11-0) (12 December 2019)
...
In [ch. 3.6](/handbook/v3/ch3#sec3.6) and [ch. 5.3](/handbook/v3/ch5#sec5.3), we suggested that the word, <E>w</E>, is a basic unit in any transcription. Each <E>w</E> element in a manuscript text can easily be supplied with information about the dictionary entry and the grammatical analysis of the word in question. We recommend that this information is provided by two attributes, <Att>lemma</Att> for the dictionary entry and <Att>me:msa</Att> for the grammatical form:
...
Note that [ch. 15.4.2](/handbook/v3/ch15#sec15.4.2) offers another way of linking annotated words to lexicographical resources. This subchapter also discusses Old Swedish and Old Danish dictionaries.
...
In [ch. 5.3.2](/handbook/v3/ch5#sec5.3.2) above the use of <E>w</E> for the encoding of graphic words and information concerning their description is treated. Note the use of entities for special characters, such as ` &fins;{:xml}` and `&nscap;{:xml}`, or abbreviations such as `&bar;{:xml}`. These are described in [ch. 5](/handbook/v3/ch5).

As noted in [ch. 4.5](/handbook/v3/ch4#sec4.5), a text may be encoded on a single level of transcription, as exemplified with “hefir” above. If the text is transcribed on more than one level there is no need for any further attributes, since each word is contained within a single <E>w</E> element and the attribute is valid for the whole contents: 
```xml
<w lemma="hafa">
  <choice>  
...
In this encoding, we use the <E>seg</E> element as a container in a similar way to the encoding of words which are written together, cf. [ch. 5.3.2](/handbook/v3/ch5#sec5.3.2). The value <Val>nb</Val> (for “no break”) indicates that there is no space between the parts in the <E>w</E> element.
...
The segmentation is in several cases open to discussion. Thus, the “t” in “fórtu” may be seen as part of the verb form or as part of the pronoun. From a phonological point of view, it is an assimilation product of the final “t” in the verb and the initial “þ” in the pronoun. As recommended in [ch. 5.3.2](/handbook/v3/ch5#sec5.3.2) above, the main word should be encoded with the fullest form and the enclitic with a reduced form, e.g.
```xml
<seg type="enc">
  <w lemma="fara">fórt</w>
  <w lemma="þú">u</w>
...
This is the traditional category of “pronoun”, as defined in the grammars of e.g. [Noreen 1923](/handbook/v3/literature#Noreen1923) and [Iversen 1973](/handbook/v3/literature#Iversen1973). From a inflectional point of view this is a heterogeneous category, but since it has been used in much lexicographical work, it is given here as an alternative to the two classes pronouns proper ([ch. 11.5.3](#sec11.5.3)) and determiners ([ch. 11.5.4](#sec11.5.4)).
...
On balance, we recommend encoding the relative particle simply as a subjunction, “xCS”. See the discussion in [Haugen and Øverland 2014](/handbook/v3/literature#Guidelines2014), p. 38.
...
On the whole, Old Norse grammars and dictionaries comply with the traditional eight word classes (parts of speech), i.e. nouns, pronouns, verbs, adjectives, adverbs, prepositions, conjunctions and interjections. We suggest that a newer set of word classes should be used, in line with what is now the standard for e.g. Modern Norwegian, cf. [Norsk referansegrammatikk (1997)](/handbook/v3/literature#NorskRef1997) by Jan Terje Faarlund, Svein Lie and Kjell Ivar Vannebo. This question is discussed at some length in the guidelines for the Menotec project, [Haugen and Øverland 2014](/handbook/v3/literature#Guidelines2014), p. 13&ndash;40.
...
**Roman numerals**. Roman numerals are frequent in Medieval Nordic texts, and should be encoded as numbers using the <E>num</E> element, e.g. <E>num</E><E>w</E>.iv.<E>/w</E><E>/num</E>. There will be no <Att>lemma</Att> attribute for Roman numerals as part of the <E>w</E> element, but they may receive <Att>type</Att> and <Att>value</Att> attributes as part of the <E>num</E> element. For details, see [ch. 5.7.1](/handbook/v3/ch5#sec5.7.1).
...
As stated above, we recommend that words are mapped to a single word class, even if they have rather diverse syntactical properties. The table below contains some of the problematic words, organised by word classes. The list is based on [Haugen and Øverland 2014](/handbook/v3/literature#Guidelines2014), pp. 23&ndash;40. Many of the words below are discussed in some detail in these guidelines.
...
See [ch. 14.5](/handbook/v3/ch14#sec14.5) for more details on language codes.
