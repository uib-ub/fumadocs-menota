...
[2. Text encoding using XML](/handbook/v3/HB3_ch2)
...
[3. Document structure](/handbook/v3/HB3_ch3)
...
[5. Characters and words](/handbook/v3/HB3_ch5)
...
[6. Abbreviations](/handbook/v3/HB3_ch6)
...
[7. Initials and other illuminations](/handbook/v3/HB3_ch7)
...
[8. Fragmentation and uncertainty](/handbook/v3/HB3_ch8)
...
[9. Scribal and editorial intervention](/handbook/v3/HB3_ch9)
...
[13. Metrical structure](/handbook/v3/HB3_ch13)
...
[14. The header](/handbook/v3/HB3_ch14)
...
[15. Linking to external resources](/handbook/v3/HB3_ch15)
...
[16. Dealing with overlapping structures](/handbook/v3/HB3_ch16)

The Achilles’ heel of XML encoding is that it struggles with overlapping structures. Document structure can be encoded by use of empty elements (milestones), as described in [ch. 5](/handbook/v3/HB3_ch5), but other types of overlapping structures are not as easily encoded. This chapter deals with the problem and suggests various ways of solving it.
...
3. The text itself, including the three focal levels of representing it ([ch. 4](/handbook/v3/HB3_ch4)), the representation of individual characters ([ch. 5](/handbook/v3/HB3_ch5)), abbreviations ([ch. 6](/handbook/v3/HB3_ch6)), higher-level structures such paragraphs and chapters, physical pages and lines ([ch. 3](/handbook/v3/HB3_ch3)), ornamentation ([ch. 7](/handbook/v3/HB3_ch7)), alterations made to the text by scribes and editors ([ch. 8](/handbook/v3/HB3_ch8) and [ch. 9](/handbook/v3/HB3_ch9)), rules for normalisation of the orthography ([ch. 10](/handbook/v3/HB3_ch10)), linguistic information ([ch. 11](/handbook/v3/HB3_ch11)), metrical structure ([ch. 13](/handbook/v3/HB3_ch13)), and references to people, places, and so on ([ch. 12](/handbook/v3/HB3_ch12) and [ch. 15](/handbook/v3/HB3_ch15)).
...
In [app. I](/handbook/v3/HB3_I_MenotaLight) below we offer a very simple example of a text that has been encoded using a minimum of elements and attributes. It is a short extract from a fragment of _Konungs skuggsjá_ in NRA 58 C.

The [Tutorial](/handbook/v3/HB3_T1) in this handbook shows how a text can be transcribed with a minimum of XML encoding, and by use of a Perl script turned into a valid Menota XML file. 