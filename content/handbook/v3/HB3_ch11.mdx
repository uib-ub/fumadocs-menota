...
Element & attributesContents`<w>`Delimits a grammatical word.   lemmaStates the lemma (lexical entry) of the word.   me:msaStates the grammatical (morphosyntactical) form of the word.
