...
Element & attributesContents`<w>`Delimits a grammatical word.&ensp;&ensp;&ensp;`@lemma`States the lemma (lexical entry) of the word.&ensp;&ensp;&ensp;`@me:msa`States the grammatical (morphosyntactical) form of the word.
...
FormLemmaGrammatical formhannhannNominativehan`<am>`&bar;`</am>`h`<am>`&bar;`</am>`h`<am>`&bar;`</am>`nha&nscap;hanshannGenitivehanſh`<am>`&bar;`</am>`sh`<am>`&bar;`</am>`ſhonumhannDativehonomh`<am>`&bar;`</am>`m
...
Name tokenInflectional classiSTStrongiWKWeakiRDReduplicatingiPPPreterite-Presentetc.
...
Name tokenValuenSSingularnDDualnPPluralnUUnspecified
...
Name tokenValuecADAccusative or DativecGDGenitive or DativecANAccusative or NominativecAGAccusative or GenitivecOOblique (i.e. Accusative, Dative or Genitive)11.3.2.4 Species
...
Name tokenValuemINSUIndicative or SubjunctivemINIMIndicative or ImperativemSUIMSubjunctive or Imperative11.3.2.9 Voice
...
Name tokenValueePEnclitic pronouneNEnclitic negative particle
...
LemmaWord formGrammatical formsinnsinnixNC **cD** nS gN sIsinnisinnixNC **cD** nS gN sIsinnisinnixNC **cA** nS gN sI
...
Word classCaseNumberGenderSpeciesxNC<br/>
...
Word classCaseNumberGenderGradeSpeciesxAJcN<br/>
...
Word classCaseNumberGenderxPQcN<br/>
...
Word classCaseNumberGenderxPIcN<br/>
...
Word classCaseNumberGenderxDDcN<br/>
...
Word classCaseNumberGenderxDQcN<br/>
...
Word classCaseNumberGenderxDPcN<br/>
...
Word classCaseNumberGenderxPDcN<br/>
...
Word classCaseGenderSpeciesxNA<br/>
...
Word classCaseNumberGenderxATcN<br/>
...
Word classFinitenessPersonNumberTenseMoodVoicexVBfFp1<br/>
...
Word classFinitenessTenseCaseNumberGenderxVB<br/>
fP<br/>
tPS<br/>
...
Word classFinitenessVoicexVB<br/>
fSvA<br/>
...
Word classFinitenessTenseVoicexVB<br/>
fItPS<br/>
...
Word classSpecificationxAPall prototypical prepositionsxVPin absolute or adverbial use (e.g. as verbal particles)
...
2. The _u_ mutation of the vowel _a_ is spelt “ǫ”, not “ö”.
...
Complex prepositionSingle formLemmaá/í mótmót[mót](https://onp.ku.dk/onp/onp.php?o55300) (xNC)á/í mótimóti[mót](https://onp.ku.dk/onp/onp.php?o55300) (xNC)í gegngegn[gegn](https://onp.ku.dk/onp/onp.php?o98899) (xNC)í gegnumgegnum[gegn](https://onp.ku.dk/onp/onp.php?o98899) (xNC)
...
Complex subjunctionLemma 1st wordLemma 2nd wordLemma 3rd wordfyrir þvífyrir (xAP)sá (xDD)fyrir því atfyrir (xAP)sá (xDD)at (xCS)sakir þess atsǫk (xNC)sá (xDD)at (xCS)svá atsvá (xAV)at (xCS)þá erþá (xAV)er (xCS)þegar erþegar (xAV)er (xCS)þó atþó (xAV)at (xCS)því atsá (xDD)at (xCS)
...
Complex subjunctionContracted formLemmasvá atsvátsvá (xAV)þegar erþegarsþegars (xAP)þó atþóttþótt (xAV)
...
CaseValuecNnominativecVvocativecAaccusativecGgenitivecDdativecBablativecUunspecified

The abbreviation **B** has been chosen for “ablative” since **A** is already used for “accusative”.
TenseValuetPSpresenttIPimperfecttFSfuture simpletPFperfecttPPpluperfecttFPfuture perfecttUunspecified

The Medieval Nordic languages have the very simple distinction between **tPS** for “present” and **tPT** for “past”.
VoiceValuevAActivevPPassivevDDeponentvUUnspecified
