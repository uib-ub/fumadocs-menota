...
Element & attributesContents`<w>`Delimits a grammatical word.   `@lemma`States the lemma (lexical entry) of the word.   `@me:msa`States the grammatical (morphosyntactical) form of the word.
