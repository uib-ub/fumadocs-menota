...
| Element and attributes  | Display |
|-----|-----|
| &lt;supplied reason="restoration"&gt;<br/>
 | Square brackets, `005B` and `005D` respectively, e.g. [S]á einn maðr |
| &lt;supplied reason="emendation"&gt; | Open angle brackets, `27E8` and `27E9`, e.g. hafi ⟨þik⟩ þangat sent  |
