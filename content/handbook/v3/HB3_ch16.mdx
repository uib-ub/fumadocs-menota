...
| `"gap"` | For contents that would otherwise be contained by the `<gap/>` element, cf. [ch. 8](HB3_ch8.xml). |
| `"unclear"` | For contents that would otherwise be contained by the `<unclear>` element, cf. [ch. 8](HB3_ch8.xml). |
| `"add"` | For contents that would otherwise be contained by the `<add>` element, cf. [ch. 9](HB3_ch9.xml). |
| `"del"` | For contents that would otherwise be contained by the `<del>` element, cf. [ch. 9](HB3_ch9.xml). |
| `"sic"` | For contents that would otherwise be contained by the `<sic>` element, cf. [ch. 9](HB3_ch9.xml). |
| `"corr"` | For contents that would otherwise be contained by the `<corr>` element, cf. [ch. 9](HB3_ch9.xml). |
| `"surplus"` | For contents that would otherwise be contained by the `<surplus>` element, cf. [ch. 9](HB3_ch9.xml). |
| `"supplied"` | For contents that would otherwise be contained by the `<supplied>` element, cf. [ch. 9](HB3_ch9.xml). |
...
| Elements | Display |
|-----|-----|
| `<gap/>` | If there is an estimate of the size of the gap, by a number of spaces, cf. [ch. 8.2.2](HB3_ch8.xml#sec8.2.2). |
| `<space/>` | If there is an estimate of the size of the space, by a number of spaces, cf. [ch. 8.3.2](HB3_ch8.xml#sec8.3.2). |
| `<unclear>` | By grey colouring, cf. [ch. 8.4.2](HB3_ch8.xml#sec8.4.2). |
...
| Elements | Display |
|-----|-----|
| `<add>` | By insertion signs, cf. [ch. 9.2.1.2](HB3_ch9.xml#sec9.2.1.2). |
| `<del>` | By vertical bars with quill, cf. [ch. 9.2.2.2](HB3_ch9.xml#sec9.2.2.2). |
| `<supplied>` | By square brackets or by open angle brackets, [ch. 9.3.1.3](HB3_ch9.xml#sec9.3.1.3). |
| `<surplus>` | By curly brackets, [ch. 9.3.2.2](HB3_ch9.xml#sec9.3.2.2). |
