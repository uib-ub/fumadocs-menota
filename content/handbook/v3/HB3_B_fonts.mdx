...
As of v. 2.0 of the Menota handbook, MUFI compatible fonts are recommended for the display of any texts encoded according to the Menota guidelines. A list of MUFI compatible fonts can be found on the MUFI web site, in the section **MUFI fonts**:[MUFI compatible fonts](http://www.mufi.info)
...
Since 2016, all texts in the archive of Menota have been displayed by Web Open Format Fonts, so that no special fonts need to be installed for browsing. See:[Menota Public catalogue](http://clarino.uib.no/menota/catalogue/menota).