...
The remaining chapters and appendices have been revised by Tone Merete Bruvik and Odd Einar Haugen. Tone Merete Bruvik has checked and validated all examples, given advice on all kinds of encoding questions and developed new TEI P5 conformant schemas. Thus, Appendix D is her work entirely. Due to her long-standing contribution to the handbook she is now included as one of the six authors of the book, as will appear on the new [title page](HB2_TitlePage.pdf). The remaining parts of the revision have been implemented by Odd Einar Haugen.
